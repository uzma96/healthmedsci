...
<div class="login-box">
    <div class="login-logo">
        <a href="assets/admin/index2.html"><b>Journal</b>Administration</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        @endif
        <form action="secure/login" method="post" autocomplete="off">
            {{csrf_field()}}
            <div class="form-group has-feedback">
                <input type="email" class="form-control" placeholder="Email" name="email" value="admin@demo.com" >
